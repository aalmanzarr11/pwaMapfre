...
export class GtStringsService {
  ...
  static data = {
    ...
    'enterCarLabelDocument' : 'Ingresa tu DPI',
    ...
    'instructBody' : '<p>1. Activar el GPS en el dispositivo móvil.</p><p>2. Tarjeta de circulación del vehículo a mano.</p><p>3. Ubicar el vehículo en el exterior y contar con buena iluminación.</p><p>4. El plazo máximo para realizar la inspección es de 15 días desde que se agenda.</p><p>5. Comprobar conexión a internet, wi-fi o datos móviles.</p><p>6. Indicar el tiempo de actividad de la PWA.</p>',
    ...
    'privacy_file' : 'Politica_privacidad_MAPFRE_Guatemala.pdf',
    'grant_type' : 'PWA502PASS'
  };
}
