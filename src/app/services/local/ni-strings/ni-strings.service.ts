...
export class NiStringsService {
  ...
  static data = {
    ...
    'enterCarLabelPolicy' : 'Número póliza o número de cotización',
    ...
    'instructBody' : '<p>1. Activar el GPS en el dispositivo móvil.</p><p>2. Tarjeta de circulación del vehículo a mano.</p><p>3. Ubicar el vehículo en el exterior y contar con buena iluminación.</p><p>4. La inspección tendrá una validez de 48 horas.</p><p>5. Comprobar conexión a internet, wi-fi o datos móviles.</p><p>6. Indicar el tiempo de actividad de la PWA.</p>',
    ...
    'carPicsPart_Mandatory_16' : '0',
    'carPicsPart_Mandatory_17' : '0',
    'carPicsPart_Mandatory_18' : '0',
    'carPicsPart_Mandatory_19' : '0',
    'carPicsPart_Mandatory_20' : '0',
    'privacy_file' : 'POLITICA_DE_PRIVACIDAD_MAPFRE_NICARAGUA.pdf',
    'grant_type' : 'PWA505PASS'
  };
}
